...
$string['event_maxviews_override_created'] = 'The limitation of maxviews override created';
$string['event_maxviews_override_description'] = 'The maxviews of user of id {$a->relateduserid} in course module of id {$a->cmid}
override {$a->type} by user of id {$a->userid} and {$a->reset}';
$string['event_maxviews_override_updated'] = 'The limitation of maxviews override updated';
$string['event_maxviews_override_deleted'] = 'The limitation of maxviews override deleted';
$string['fieldlabel'] = 'Maximum views:';
$string['lastreset'] = 'Last reset';
$string['maxviews'] = 'Additional maximum views';
$string['maxviews_add'] = 'Maximum views';
...
$string['participant_help'] = 'Select the participants needed to override their maximum views for the selected course module.';
$string['pluginname'] = 'Max Views';
$string['resetviews'] = 'Reset views';
$string['resetviews_help'] = 'If this options checked, the views count for the selected users will reseted to zero for the selected course module.';
$string['resetyes'] = 'maxviews has been rest';
